...
# Thông tin tin server (Đây là client, nên thông tin này là của server mà client sẽ kết nối tới)
...
# Tạo SSL context
context = ssl.SSLContext(ssl.PROTOCOL_TLS_CLIENT) # Changed from PROTOCOL_TLS to PROTOCOL_TLS_CLIENT for client-side
